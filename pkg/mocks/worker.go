...
// Source: github.com/tbal999/pipelines/pkg (interfaces: Worker)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -destination=./mocks/worker.go -package=mocks github.com/tbal999/pipelines/pkg Worker
//
...
import (
	...
	pkg "github.com/tbal999/pipelines/pkg"
...
func (mr *MockWorkerMockRecorder) Action(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Action", reflect.TypeOf((*MockWorker)(nil).Action), arg0)
}

// Clone mocks base method.
func (m *MockWorker) Clone() pkg.Worker {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Clone")
	ret0, _ := ret[0].(pkg.Worker)
	return ret0
}
...
func (mr *MockWorkerMockRecorder) Initialise(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
